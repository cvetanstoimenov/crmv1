...
function onLoad(){
	...
	function DisplayResult(array) {
      ...
      function GetAllClanoviOfThisVotingPlace(idVotingPlace) {
         ...
         $.ajax({
             type: "GET",
             url: "https://213.147.98.165/api/values/GetAllClanoviOfThisVotingPlace",
             dataType: "json",
      ...
      function GetChangeTaskActivityStatusOfThisUser(idVotingPlace, IdOfSelectedClan, openCompletedCancelled, index) {
         ...
         $.ajax({
             type: "GET",
             url: "https://213.147.98.165/api/values/GetChangeTaskActivityStatusOfThisUser",
             dataType: "json",
      ...
      function GetVotingPlaceIfClanExist(jusername, jpassword) {
         $.ajax({
             url: "https://213.147.98.165/api/values/GetVotingPlaceIfClanExist",
             dataType: "json",
